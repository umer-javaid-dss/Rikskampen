...
public class StepCountingService extends Service implements SensorEventListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        sensorManager.registerListener(StepCountingService.this, stepCounterSensor, 0);
        sensorManager.registerListener(StepCountingService.this, stepDetectorSensor, 0);
    ...
    private void showNotification() {
        ...
        notificationBuilder.setSmallIcon(R.mipmap.ic_launcher_test);
